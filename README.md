...
* The data is non-proprietary (if in .csv format) and can therefore be investigated by readers who do not own the proprietary software solutions
* The data can easily be read by other software solutions for further processing or plotting, e.g. Python and associated libraries
